...
func newEmployee(db *gorm.DB) employee {
	...
	_employee.Id5 = field.NewInt64(tableName, "Id5")
	_employee.Id9 = field.NewInt64(tableName, "Id9")
...
func (e *employee) updateTableName(table string) *employee {
	...
	e.Id5 = field.NewInt64(table, "Id5")
	e.Id9 = field.NewInt64(table, "Id9")
...
func (e *employee) fillFieldMap() {
	...
	e.fieldMap["Id5"] = e.Id5
	e.fieldMap["Id9"] = e.Id9
