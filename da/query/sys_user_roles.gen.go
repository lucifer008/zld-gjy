...
func newSysUserRole(db *gorm.DB) sysUserRole {
	...
	_sysUserRole.Id14 = field.NewInt64(tableName, "Id14")
	_sysUserRole.Id3 = field.NewInt64(tableName, "Id3")
	_sysUserRole.Id2 = field.NewInt64(tableName, "Id2")
...
func (s *sysUserRole) updateTableName(table string) *sysUserRole {
	...
	s.Id14 = field.NewInt64(table, "Id14")
