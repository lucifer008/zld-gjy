...
func newSysResource(db *gorm.DB) sysResource {
	...
	_sysResource.SysID = field.NewInt64(tableName, "Sys_Id")
	...
	_sysResource.InsertDateTime = field.NewTime(tableName, "Insert_Date_Time")
	_sysResource.InsertUser = field.NewInt64(tableName, "Insert_User")
	_sysResource.UpdateDateTime = field.NewTime(tableName, "Update_Date_Time")
	_sysResource.UpdateUser = field.NewInt64(tableName, "Update_User")
	_sysResource.Version = field.NewInt32(tableName, "Version")
	_sysResource.Deleted = field.NewString(tableName, "Deleted")
