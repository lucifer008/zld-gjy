...
func newStore(db *gorm.DB) store {
	...
	_store.ID = field.NewInt64(tableName, "Id")
	_store.StoreName = field.NewString(tableName, "Store_Name")
	_store.StoreTel = field.NewString(tableName, "Store_Tel")
	_store.StoreAddress = field.NewString(tableName, "Store_Address")
	_store.Memo = field.NewString(tableName, "Memo")
...
type store struct {
	...
	ALL          field.Asterisk
	ID           field.Int64  // 仓储Id
	StoreName    field.String // 仓储名称
	StoreTel     field.String // 联系电话
	StoreAddress field.String // 地址
...
func (s *store) updateTableName(table string) *store {
	...
	s.StoreTel = field.NewString(table, "Store_Tel")
	s.StoreAddress = field.NewString(table, "Store_Address")
...
func (s *store) fillFieldMap() {
	...
	s.fieldMap["Store_Tel"] = s.StoreTel
	s.fieldMap["Store_Address"] = s.StoreAddress
